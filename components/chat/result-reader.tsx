...
/**
 * Full-page article reader — Medium-style immersive experience.
 * Rendered as a full page (not a modal), so native document scroll
 * triggers iOS Safari address bar collapse.
...
export function ResultReader({
  ...
  // WHY: Native window scroll → header hide/show + progress bar.
  // Using window scroll (not inner div) so iOS collapses address bar.
  useEffect(() => {
  ...
  return (
    <div className="min-h-dvh bg-page text-content">
      ...
      {/* Header — fixed, slides up/down based on scroll direction */}
      <div
      ...
      {/* Article content — normal document flow */}
      <div className="pt-12" />
