...
function DevLoginForm() {
  const [email, setEmail] = useState("test@openclaw.jobs");
    ...
    <>
      ...
      >
        <input
          ...
          placeholder="test@openclaw.jobs"
          className="w-full rounded-lg border border-yellow-700/50 bg-zinc-900 px-4 py-3 text-sm text-zinc-200 outline-none focus:border-yellow-500"
        />
        <button
          type="submit"
          className="w-full rounded-lg border border-yellow-600 bg-yellow-600/10 px-4 py-3 text-sm font-medium text-yellow-500 transition-colors hover:bg-yellow-600/20"
        >
          Dev Login (any email)
        </button>
      </form>
